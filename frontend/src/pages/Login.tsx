      ...
      <div className="hidden lg:flex w-1/2 gradient-primary text-primary-foreground p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative">
          <div className="flex items-center gap-3">
            <div className="relative w-14 h-14 rounded-2xl bg-white dark:bg-slate-950/80 overflow-hidden flex items-center justify-center border border-primary/20 shadow-[0_8px_32px_rgba(var(--primary),0.1)] transition-all duration-500 hover:scale-110 hover:border-primary/40 cursor-pointer group">
              {/* Radar Grid Background */}
              <div className="absolute inset-0 bg-[linear-gradient(to_right,hsl(var(--primary)/0.06)_1px,transparent_1px),linear-gradient(to_bottom,hsl(var(--primary)/0.06)_1px,transparent_1px)] bg-[size:8px_8px] opacity-60" />
              {/* Radar Circles */}
              <div className="absolute w-10 h-10 rounded-full border border-primary/10 animate-ping [animation-duration:4s]" />
              <div className="absolute w-6 h-6 rounded-full border border-primary/15" />
              {/* Radar Sweep Line */}
              <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-primary/20 to-transparent rounded-full animate-spin [animation-duration:2.5s]" />
              {/* Blip Ping */}
              <div className="absolute w-1.5 h-1.5 rounded-full bg-primary shadow-[0_0_10px_hsl(var(--primary))] animate-pulse" style={{ top: '25%', left: '30%' }} />
              ...
              <Radar className="h-6 w-6 text-primary relative z-10 transition-transform duration-500 group-hover:scale-110" />
            </div>
            <div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12 overflow-y-auto bg-gradient-to-br from-background via-background to-muted/20">
        <div className="w-full max-w-md space-y-6 py-8 px-6 sm:px-8 bg-card/60 backdrop-blur-md rounded-2xl border border-border/80 shadow-[0_12px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)] transition-all duration-500">
          <div className="lg:hidden flex items-center gap-3">
            <div className="relative w-10 h-10 rounded-xl bg-white dark:bg-slate-950/90 overflow-hidden flex items-center justify-center border border-primary/20 shadow-[0_4px_16px_rgba(var(--primary),0.06)] group transition-all duration-300 hover:scale-105">
              {/* Radar Grid Background */}
